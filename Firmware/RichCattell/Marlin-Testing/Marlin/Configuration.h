...
#define DELTA_CARRIAGE_OFFSET 39.04 // 24 // mm
...
#define BED_DIAMETER 160 //170 // mm
...
#define Z_PROBE_OFFSET {0, -22.9, -1.3, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
// J-Head with 12v 40W heater cartridge
    #define  DEFAULT_Kp 18.73 //15.34
    #define  DEFAULT_Ki 1.58 //1.57
    #define  DEFAULT_Kd 55.53 //37.45
...
#define MANUAL_Z_HOME_POS 265  // For delta: Distance between nozzle and print surface after homing.
...
#define ABS_PREHEAT_FAN_SPEED 100 //255   // Insert Value between 0 and 255
